...
`;function _t(t){const e=new Date;e.setHours(0,0,0,0);const s=new Date(`${t}T00:00:00`);return Math.round((s.getTime()-e.getTime())/864e5)}function bt(t,e){const s=t.hass.locale?.language??"en";return new Date(`${e}T00:00:00`).toLocaleDateString(s,{weekday:"short",day:"numeric",month:"short"})}function $t(t){if(!t.budget)return q;const{total:e,planned:s}=t.budget,i=s>e,n=e>0?Math.min(100,s/e*100):0;return L`
  ...
  `}function xt(t,e,s){return`${t}-${String(e+1).padStart(2,"0")}-${String(s).padStart(2,"0")}`}function wt(){const t=new Date;return xt(t.getFullYear(),t.getMonth(),t.getDate())}function At(t,e,s,i,n){const r=new Date(s,i+1,0).getDate(),o=(new Date(s,i,1).getDay()+6)%7,a=wt(),l=Array.from({length:o},()=>null);for(let t=1;t<=r;t+=1){const r=xt(s,i,t),c=(o+t-1)%7;l.push({iso:r,day:t,weekend:c>=5,past:r<a,holidayName:n.holidayByIso.get(r),block:n.blockByVacationIso.get(r),inFreeRange:n.freeRangeIso.has(r),planned:n.plannedByIso.get(r),selected:e.selStart===r})}return L`
    <div class="month">
      ...
      <div class="month-grid">
        ...
        ${l.map(t=>{if(null===t)return L`<span></span>`;const s=["day",t.weekend?"weekend":"",t.past?"past":"",t.holidayName?"holiday":"",t.inFreeRange&&!t.block?"range":"",t.block?"block":"",t.planned?"is-planned":"",t.selected?"selected":"",t.iso===wt()?"today":""].filter(Boolean).join(" "),i=t.block?`--fen-day-color:${yt(t.block.efficiency)}`:"";return L`
            <button
              class=${s}
              style=${i}
              title=${t.holidayName??""}
  ...
  `}function kt(t,e){const s=Object.keys(t.years).sort();if(!s.length)return L`<div class="hint">${t.t("no_blocks")}</div>`;const i=e.activeYear??s[0],n=Number(i),r=function(t,e){const s=t.years[e],i=new Map,n=new Map,r=new Set;for(const t of s?.holidays??[])i.set(t.date,t.local_name);const o=t.config.levels;for(const t of s?.blocks??[]){if(o?.length&&!o.includes(t.level))continue;for(const e of t.vacation_dates)n.set(e,t);const e=new Date(`${t.free_range_start}T00:00:00`),s=new Date(`${t.free_range_end}T00:00:00`);for(let t=e.getTime();t<=s.getTime();t+=864e5){const e=new Date(t);r.add(xt(e.getFullYear(),e.getMonth(),e.getDate()))}}const a=new Map;for(const e of t.planned)for(const t of e.vacation_dates)a.set(t,e);return{holidayByIso:i,blockByVacationIso:n,freeRangeIso:r,plannedByIso:a}}(t,i);return L`
    <div class="year-head">
      ...
      ${t.config.show_budget?$t(t):q}
    </div>
    ${e.selStart?L`<div class="pick-hint">${t.t("pick_end")}</div>`:q}
    <div class="months">
      ${Array.from({length:12},(s,i)=>At(t,e,n,i,r))}
    </div>
  ...
  `}(t);break;case"year":e=kt(t,this);break;default:e=function(t,e){return t.blocks.length?L`
  ...
  `:L`<div class="hint">${t.t("no_blocks")}</div>`}(t,this)}return L`
    ...
    `}};t([ht({attribute:!1})],Et.prototype,"hass",void 0),t([pt()],Et.prototype,"_config",void 0),t([pt()],Et.prototype,"selStart",void 0),t([pt()],Et.prototype,"activeYear",void 0),t([pt()],Et.prototype,"_dialog",void 0),Et=t([lt(ut)],Et);const St=[{name:"entity",required:!0,selector:{entity:{domain:"sensor"}}},{name:"mode",selector:{select:{mode:"dropdown",options:[{value:"compact",label:"Compact"},{value:"list",label:"List"},{value:"year",label:"Year planner"}]}}},{name:"title",selector:{text:{}}},{name:"show_budget",selector:{boolean:{}}},{name:"levels",selector:{select:{multiple:!0,options:["1","2","3","4","5"].map(t=>({value:t,label:`Level ${t}`}))}}}];let Ct=class extends ot{setConfig(t){this._config=t}render(){if(!this.hass||!this._config)return q;const t={...this._config,levels:(this._config.levels??[]).map(String)};return L`
      <ha-form
        .hass=${this.hass}
        .data=${t}
        .schema=${St}
      ...
      ></ha-form>
    `}_valueChanged(t){t.stopPropagation();const e=t.detail.value,{levels:s,...i}=e,n=s?.length?{...i,levels:s.map(Number)}:i;this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:n},bubbles:!0,composed:!0}))}};t([ht({attribute:!1})],Ct.prototype,"hass",void 0),t([pt()],Ct.prototype,"_config",void 0),Ct=t([lt(gt)],Ct);var Pt=Object.freeze({__proto__:null,get FenstertageCardEditor(){return Ct}});export{Et as FenstertageCard};
